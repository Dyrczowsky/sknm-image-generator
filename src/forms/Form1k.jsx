...
// Formularz dla 1k · Wykład (szary monochrom) - te same pola co 1a, inna kolorystyka.
export function Form1k({ value, onFieldChange, onLogoChange, onLogoEnabledChange }) {
  return (
