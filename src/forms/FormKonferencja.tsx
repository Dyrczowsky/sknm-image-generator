...
export function FormKonferencja({ value, onFieldChange, onVisibilityChange, onGraphicsAdd, onGraphicRemove, onGraphicMove, onShowPkChange, onListItemAdd, onListItemChange, onListItemRemove }: FormProps) {
