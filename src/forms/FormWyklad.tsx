...
// Formularz dla Wykładu.
export function FormWyklad({ value, onFieldChange, onVisibilityChange, onGraphicsAdd, onGraphicRemove, onGraphicMove, onShowPkChange, onQrUrlChange, onQrColorChange }: FormProps) {
