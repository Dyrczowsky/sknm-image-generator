...
// Formularz dla 1j · Wykład (granat na jasnym) - te same pola co 1a, inna kolorystyka.
export function Form1j({ value, onFieldChange, onLogoChange, onLogoEnabledChange }) {
  return (
