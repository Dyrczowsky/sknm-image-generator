...
// 1d · DATA — wariant szary monochrom
export function Poster1dSzary({ data }) {
    ...
    <PosterFrame background={colors.paper} color={colors.slate} padding={72}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 24 }}>
        <div style={{ display: 'flex', gap: 6 }}>
          <div style={{ width: 56, height: 44, background: colors.grayDark, clipPath: 'polygon(0 0,100% 0,50% 100%)' }} />
          <div style={{ width: 56, height: 44, background: colors.gray, clipPath: 'polygon(0 0,100% 0,50% 100%)' }} />
