...
// 1f · REKRUTACJA — wariant jasny (papierowe tło zamiast limonki, granat na dole)
export function Poster1fJasny({ data }) {
  const { title, subtitle, event_date, event_time, location, badge, logos } = withPlaceholders(data)

  return (
    <PosterFrame background={colors.paper} color={colors.navy} padding={72}>
      <div
        style={{
