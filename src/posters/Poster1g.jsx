...
export function Poster1g({ data }) {
  ...
  return (
    <PosterFrame background={colors.ink} color={colors.goldPanelText} padding={72}>
      ...
      <div style={{ position: 'absolute', top: 232, left: 0, right: 0, height: 1, background: `linear-gradient(to right, rgba(132,117,78,0) 0, ${colors.gold} 18%, ${colors.gold} 82%, rgba(132,117,78,0) 100%)` }} />
