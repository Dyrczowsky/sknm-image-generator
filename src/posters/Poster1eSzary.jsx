...
// 1e · KONFERENCJA — wariant szary monochrom
export function Poster1eSzary({ data }) {
  ...
  return (
    <PosterFrame background={colors.paper} color={colors.slate}>
      <div style={{ background: colors.grayDark, color: colors.cream, padding: '56px 72px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', gap: 32 }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          <Badge color={colors.cream}>{badge || 'SEMINARIUM SKNM'}</Badge>
        ...
        <img src={sygnetSzary} alt="SKNM" style={{ width: 132, display: 'block', flex: '0 0 auto' }} />
      </div>
      ...
      <div style={{ flex: 1, padding: '48px 72px 72px', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          ...
          {agenda.map((item, i) => (
            <div
              ...
              style={{
                ...
                gap: 24,
                padding: '22px 0',
                borderTop: `2px solid ${i === 0 ? colors.grayDark : colors.creamMuted}`,
                alignItems: 'baseline',
              }}
            >
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 24 }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            <Badge color={colors.grayDark} style={{ font: `700 20px ${fontMono}`, letterSpacing: '.12em' }}>{badge2 || 'WIĘCEJ INFORMACJI'}</Badge>
