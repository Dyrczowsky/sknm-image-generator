...
// 1f · REKRUTACJA — wariant szary monochrom
export function Poster1fSzary({ data }) {
  ...
  return (
    <PosterFrame background={colors.paper} color={colors.slate} padding={72}>
      <div
        style={{
          position: 'absolute', bottom: 0, left: 0, right: 0, height: 340, background: colors.grayDark,
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 26, position: 'relative', maxWidth: 900 }}>
        ...
        <div style={{ fontSize: 38, fontWeight: 600, lineHeight: 1.3, color: colors.textMuted }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 32, position: 'relative', color: colors.cream }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12, paddingBottom: 8 }}>
          <Badge color={colors.cream} style={{ font: `700 26px ${fontMono}`, letterSpacing: '.1em' }}>{badge || 'SPOTKANIE ORGANIZACYJNE'}</Badge>
